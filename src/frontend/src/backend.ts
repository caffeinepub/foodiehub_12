...
export class Backend implements backendInterface {
    ...
    async createFoodItem(arg0: FoodItem): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createFoodItem(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteFoodItem(arg0: bigint): Promise<FoodItem> {
        if (this.processError) {
            try {
    ...
    async filterFoodItemsByCategory(arg0: string): Promise<Array<FoodItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterFoodItemsByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateOrderStatus(arg0: bigint, arg1: string): Promise<Order> {
        if (this.processError) {
            try {
